...
// 1558 as per recommended on vape.gg
#define FORGE_VERSION_MAJOR		10
#define FORGE_VERSION_MINOR		13
#define FORGE_VERSION_REVISION	4
#define FORGE_VERSION_BUILD		1558
...
VOID RecommendForgeDownload( VOID )
{
	...
	if( IDYES == result )
	{
		ShellExecute( NULL, L"open", L"http://files.minecraftforge.net/maven/net/minecraftforge/forge/1.7.10-10.13.4.1558-1.7.10/forge-1.7.10-10.13.4.1558-1.7.10-installer-win.exe", L"", L".", SW_SHOWDEFAULT );
	}
}
//===============================================================================================//
